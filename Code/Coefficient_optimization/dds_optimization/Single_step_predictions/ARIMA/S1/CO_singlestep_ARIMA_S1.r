...
load("Coefficient_optimization/dds_optimization/Single_step_predictions/ARIMA/orders.rdata")
...
assign(name, results)
filename <- paste("Coefficient_optimization/dds_optimization/Single_step_predictions/ARIMA/S1/Lists/", name, ".rdata",sep = "")
