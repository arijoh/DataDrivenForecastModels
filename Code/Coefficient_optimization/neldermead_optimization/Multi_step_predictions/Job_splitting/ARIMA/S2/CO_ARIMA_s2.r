...
name <- paste("CO_ARIMA_s2_c(", order[1], ", ", order[2], ", ", order[3], ")", sep = "")
assign(name, results)
filename <- paste("Coefficient_optimization/neldermead_optimization/Multi_step_predictions/Job_splitting/ARIMA/S2/Lists/", name, ".rdata",sep = "")
