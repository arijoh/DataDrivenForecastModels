...
load("Evaluation/Nelder-Mead/best_models/List/DamningenList_PI.Rdata")
load("Evaluation/Nelder-Mead/best_models/List/DamhusaenList_PI.Rdata")
...
# #test
# filename <- paste("../Figures/Results/Nelder-Mead/Best_model_forecasts/PI/model_", model, "_PI.svg", sep = "")
# svg(filename = filename, height= 5, width = 8)
# plot
# dev.off()
...
for (model in (1:5)){
  ...
  filename <- paste("../Figures/Results/Nelder-Mead/Best_model_forecasts/PI/ARIMA_", model, "_PI.pdf", sep = "")
