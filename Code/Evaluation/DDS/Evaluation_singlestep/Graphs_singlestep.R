...
ARIMA_S2 <- lapply(paste("Coefficient_optimization/dds_optimization/Single_step_predictions/ARIMA/S2/Lists/",files, sep = ""), function(x) mget(load(x))$results)
...
ARIMAX_S1 <- lapply(paste("Coefficient_optimization/dds_optimization/Single_step_predictions/ARIMAX/S1/Lists/",files, sep = ""), function(x) mget(load(x))$results)
...
ARIMAX_S2 <- lapply(paste("Coefficient_optimization/dds_optimization/Single_step_predictions/ARIMAX/S2/Lists/",files, sep = ""), function(x) mget(load(x))$results)
...
#### Convergence..
conv_ARIMA_S1 <- nrow(data_ARIMA_S1)
