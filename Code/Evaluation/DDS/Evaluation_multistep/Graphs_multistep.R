...
ARIMA_S1 <- lapply(paste("Coefficient_optimization/dds_optimization/Multi_step_predictions/ARIMA/S1/Lists/",files, sep = ""), function(x) mget(load(x))$results)
...
# svg(filename = "../Figures/Results/conv_both.svg")
# conv_plot
# dev.off()
