...
name <- paste("eval_ARIMA_S1_c(", X$order[1], ", ", X$order[2], ", ", X$order[3], ", ", "reg.nr=", X$reg.nr, "reg.lag=", X$reg.lag,  ")", sep = "")
assign(name, results)
filename <- paste("Evaluation/DDS/Evaluation_multistep/ARIMA/S1/Lists/", name, ".rdata",sep = "")
